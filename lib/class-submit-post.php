...
if ( ! class_exists( 'em_submit_post' ) ) :
...
class EM_Submit_Post {
	 ...
	 * @since 1.0.0
	 */
	public function EM_Submit_Post() {
		 ...
		 * @since 1.0.0
		 */
		add_shortcode( 'em_submit_post', function () {
			 ...
			 * @since 1.0.0
			 */
			if ( file_exists( EM_DIR . '/lib/view-submit-post.php' ) ) {
			    require_once( EM_DIR . '/lib/view-submit-post.php' );
			}
	...
	public function submit() {
		...
		// Verify the nonce.
        if( wp_verify_nonce( $_POST['EM_Submit_Post_nonce'], 'em_submit_post' ) ) {

            // Get post title via `post-title`.
            if ( ! empty( $_POST['post_title'] ) ) {
                $post_title = sanitize_text_field( $_POST['post_title'] );
            } else {
                $errors[] = __( 'Post Title is required!', 'EM' );
            }
            ...
            if ( count( $errors ) == 0 ) {
                ...
                if( current_user_can( 'manage_options' ) ) {
                    ...
                    $output_message = __( 'Yay! Your post was successfully published!', 'EM' );
                    ...
                    $output_message = __( 'Yay! Your post was successfully submitted! Awaiting moderation!', 'EM' );
